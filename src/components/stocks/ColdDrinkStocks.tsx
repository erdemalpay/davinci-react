...
const ColdDrinkStock = () => {
  ...
  const coldDrinkStockPageDisabledCondition = useMemo(() => {
    return getItem(
      DisabledConditionEnum.STOCK_COLDDRINKSTOCK,
      disabledConditions
    );
  }, [disabledConditions]);
    ...
    return stocks
      ?.filter((stock) => {
        ...
        return (
          ...
          productExpenseType.includes(COLDDRINKEXPENSETYPE)
        );
      })
      ?.filter((stock) => {
        ...
        return (
          passesFilter(
            filterColdDrinkStockPanelFormElements?.location,
            stock?.location
          ) &&
          (!filterColdDrinkStockPanelFormElements?.product?.length ||
            filterColdDrinkStockPanelFormElements?.product?.some(
              (panelProduct: string) =>
                passesFilter(panelProduct, stock?.product)
            )) &&
          (!filterColdDrinkStockPanelFormElements?.vendor ||
            rowProduct?.vendor?.includes(
              filterColdDrinkStockPanelFormElements?.vendor
            )) &&
          (!filterColdDrinkStockPanelFormElements?.brand ||
    ...
    () => [
      {
        ...
        options: products
          ?.filter((product) =>
            product?.expenseType?.includes(COLDDRINKEXPENSETYPE)
          )
          ?.map((product) => ({
            value: product._id,
            label: product.name,
  ...
  const addButton = useMemo(
    ...
    [
      ...
      formKeys,
      createAccountStock,
      coldDrinkStockPageDisabledCondition,
      user,
    ]
  );
  ...
  const filters = useMemo(
    () => [
      ...
      },
      {
        ...
        node: (
          <SwitchButton
            checked={showColdDrinkStockPrices}
            onChange={() => {
              setShowColdDrinkStockPrices(!showColdDrinkStockPrices);
            }}
          />
        ),
        isDisabled: coldDrinkStockPageDisabledCondition?.actions?.some(
      ...
      },
      {
        ...
        node: (
          <SwitchButton
            checked={isColdDrinkStockEnableEdit}
            onChange={() => {
              setIsColdDrinkStockEnableEdit(!isColdDrinkStockEnableEdit);
            }}
          />
        ),
        isDisabled: coldDrinkStockPageDisabledCondition?.actions?.some(
      ...
      },
      {
        ...
        node: (
          <SwitchButton
            checked={showColdDrinkStockFilters}
            onChange={() => {
              setShowColdDrinkStockFilters(!showColdDrinkStockFilters);
            }}
          />
        ),
      },
  ...
  const filterPanel = useMemo(
    () => ({
      isFilterPanelActive: showColdDrinkStockFilters,
      inputs: filterPanelInputs,
      formElements: filterColdDrinkStockPanelFormElements,
      setFormElements: setFilterColdDrinkStockPanelFormElements,
      closeFilters: () => setShowColdDrinkStockFilters(false),
    }),
    [
      showColdDrinkStockFilters,
      filterPanelInputs,
