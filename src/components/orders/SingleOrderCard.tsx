...
const SingleOrderCard = ({ order, user }: Props) => {
  ...
  return (
    <div className="flex flex-col justify-between border border-gray-200 rounded-lg bg-white shadow-sm  h-24 __className_a182b8">
      <div className="flex flex-row gap-4  px-2 mt-1  overflow-scroll no-scrollbar ">
        {/* img & time */}
      ...
      {/* buttons */}
      <div className="  flex flex-row justify-between  px-2 ml-auto overflow-hidden mt-[-0.2rem] ">
