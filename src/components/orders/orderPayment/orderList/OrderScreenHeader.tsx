...
const OrderScreenHeader = ({ header }: Props) => {
  ...
  return (
    <div className="relative text-center py-2 mb-2 sticky top-0 bg-white z-10">
      <h1 className="relative z-20 bg-blue-gray-50 px-3 py-1 rounded-full inline-block mx-1">
        {t(header)}
      </h1>
